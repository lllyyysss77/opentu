...
- shots: 镜头详细信息数组，每个对象包含：
  ...
  - visual_prompt: 图片生成提示词，详细描述画面静态内容，用于 AI 生成类似画面的静态图
  - video_prompt: 视频生成提示词，描述主体动作、运镜方式、节奏感、氛围。与 visual_prompt 的区别是要强调动态和时间维度。
...
所有字段统一使用同一种语言输出，语言与视频中的口播/文字语言保持一致。
